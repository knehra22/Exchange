    ...
    return (
        <>
            <div className=" flex flex-col text-neutral-200 text-5xl tracking-wide text-center  gap-5 items-center mt-10" style={{fontFamily:"unset"}}> 
                ...
                <button className="rounded-xl bg-sky-800 text-neutral-200 text-center m-5 pl-6 pr-6  pt-3 pb-3 text-[20px] font-light  tracking-tight  cursor-pointer " onClick={() => router.push('/market')}> Trade</button>
            </div>
        </>
    );
}